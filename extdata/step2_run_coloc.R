...
option_list <- list(
    ...
    optparse::make_option(c("--p1"), type="double", default=1e-4, help="to be filled"), 
    optparse::make_option(c("--p2"), type="double", default=1e-4, help="to be filled"), 
    optparse::make_option(c("--p12"), type="double", default=1e-5, help="to be filled"),
